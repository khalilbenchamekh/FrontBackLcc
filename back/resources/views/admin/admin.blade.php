                ...
                <ul class="navbar-nav ms-auto d-flex align-items-center">
                    ...
                    <li>
                        <a class="profile-pic" href="#">
                            <img src="vendor/plugins/images/users/varun.jpg" alt="user-img" width="36"
                        ...
                        <div class="card-body">
                            <ul class="chatonline">
                                ...
                                <li>
                                    ...
                                    <a href="javascript:void(0)" class="d-flex align-items-center"><img
                                            src="vendor/plugins/images/users/ritesh.jpg" alt="user-img" class="img-circle">
                                        <div class="ms-2">
                                ...
                                <li>
                                    ...
                                    <a href="javascript:void(0)" class="d-flex align-items-center"><img
                                            src="vendor/plugins/images/users/govinda.jpg" alt="user-img"
                                            class="img-circle">
                                        <div class="ms-2">
                                ...
                                <li>
                                    ...
                                    <a href="javascript:void(0)" class="d-flex align-items-center"><img
                                            src="vendor/plugins/images/users/hritik.jpg" alt="user-img" class="img-circle">
                                        <div class="ms-2">
