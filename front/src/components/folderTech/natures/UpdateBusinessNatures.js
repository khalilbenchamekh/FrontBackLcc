...
import {deleteFolderTechNaturesAction, updateFolderTechNaturesAction} from "../../../actions/folderTechActions";
...
class UpdateBusinessNatures extends React.Component {
    ...
    updateClick = () => {
        ...
        this.props.updateFolderTechNaturesAction(token, obj,this.props.id);
        this.setState({
            open: !this.state.open
        });
    };
    ...
    delete = () => {
        ...
        confirmAlert({
            ...
            buttons: [
                {
                    label: 'Yes',
                    onClick: () => this.props.deleteFolderTechNaturesAction(token, obj,this.props.id)
                },
                {
                    label: 'No',
                }
