...
import {addFolderTechNaturesAction, addMultipleFolderTechNaturesAction} from "../../../actions/folderTechActions";
...
class CustomToolbar extends React.Component {
    ...
    addClick = () => {
        ...
        this.props.addFolderTechNaturesAction(token, this.state.name);
        this.setState({
            open:!this.state.open
        });
    };
                    ...
                    <Dialog open={open} onClose={this.handleClick} aria-labelledby="form-dialog-title">
                        ...
                        <DialogActions>
                            ...
                            <div className="form-group files">
                                <input type="file" accept=".csv, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel" className="form-control" multiple onChange={this.fileHandler.bind(this)} />
...
const mapDispatchToProps = {
    addFolderTechNaturesAction,
    addMultipleFolderTechNaturesAction
};
