...
class UpdateBusinessSituations extends React.Component {
    ...
    updateClick = () => {
        ...
        this.props.updateFolderTechSituationsAction(token, obj, this.props.id);
        this.setState({
            open: !this.state.open
        });
    };
    ...
    delete = () => {
        ...
        confirmAlert({
            ...
            buttons: [
                {
                    label: 'Yes',
                    onClick: () => this.props.deleteFolderTechSituationsAction(token, obj, this.props.id)
                },
                {
                    label: 'No',
                }
...
const mapDispatchToProps = {
    updateFolderTechSituationsAction,
    deleteFolderTechSituationsAction
};
