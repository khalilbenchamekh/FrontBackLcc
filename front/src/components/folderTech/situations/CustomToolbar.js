...
class CustomToolbar extends React.Component {
    ...
    addClick = () => {
        ...
        this.props.addFolderTechSituationsAction(token, obj);
        this.setState({
            open: !this.state.open
        });
    };
                    ...
                    if (err) {
                        ...
                        if (resp.rows.length > 0) {
                            ...
                            if (nbr !== 0) {
                                ...
                                this.props.addMultipleFolderTechSituationsAction(token, businessNatures)
...
const mapDispatchToProps = {
    addFolderTechSituationsAction,
    addMultipleFolderTechSituationsAction
};
