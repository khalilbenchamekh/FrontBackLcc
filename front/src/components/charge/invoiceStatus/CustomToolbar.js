...
import {addInvoiceStatusAction} from "../../../actions/invoiceStatusActions";
...
class CustomToolbar extends React.Component {
    ...
    addClick = () => {
        ...
        this.props.addInvoiceStatusAction(token, this.state.name);
        this.setState({
            open:!this.state.open
        });
    };
...
function mapStateToProps(state) {
    return {
        ...
        error: state.invoiceStatus.error,
    };
}
