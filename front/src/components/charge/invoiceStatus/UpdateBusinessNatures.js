...
import {deleteInvoiceStatusAction, updateInvoiceStatusAction} from "../../../actions/invoiceStatusActions";
...
class UpdateBusinessNatures extends React.Component {
    ...
    updateClick = () => {
        ...
        this.props.updateInvoiceStatusAction(token, obj, this.props.id);
        this.setState({
            open: !this.state.open
        });
    };
    ...
    delete = () => {
        ...
        confirmAlert({
            ...
            buttons: [
                {
                    label: 'Yes',
                    onClick: () => this.props.deleteInvoiceStatusAction(token, obj, this.props.id)
                },
                {
                    label: 'No',
                }
