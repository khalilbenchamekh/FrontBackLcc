...
import {deleteChargeNatureAction, updateChargeNatureAction} from "../../../actions/chargeTypeActions";
...
class UpdateBusinessNatures extends React.Component {
    ...
    updateClick = () => {
        ...
        this.props.updateChargeNatureAction(token, obj, this.props.id);
        this.setState({
            open: !this.state.open
        });
    };
    ...
    delete = () => {
        ...
        confirmAlert({
            ...
            buttons: [
                {
                    label: 'Yes',
                    onClick: () => this.props.deleteChargeNatureAction(token, obj, this.props.id)
                },
                {
                    label: 'No',
                }
...
const mapDispatchToProps = {
    updateChargeNatureAction,
    deleteChargeNatureAction
};
