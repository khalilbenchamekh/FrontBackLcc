...
import { updateFolderTechFeesAction } from "../../../actions/feesActions";
...
class UpdateBusinessNatures extends React.Component {
    ...
    submitForm = (e) => {
        ...
        this.props.updateFolderTechFeesAction(token, formdata, this.props.index.id, this.props.id);
        this.setState({
            open: !this.state.open
        });
    };
