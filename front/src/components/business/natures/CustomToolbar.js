...
import {
    addBusinessNaturesAction,
    addMultipleBusinessNaturesAction,
...
class CustomToolbar extends React.Component {
    ...
    addClick = () => {
        ...
        this.props.addBusinessNaturesAction(token, this.state.name);
        this.setState({
            open:!this.state.open
        });
    };
                    ...
                    if(err){
                        ...
                        if(resp.rows.length>0){
                            ...
                            if(nbr!==0){
                                ...
                                this.props.addMultipleBusinessNaturesAction(token,businessNatures)
